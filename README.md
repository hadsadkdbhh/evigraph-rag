...
`full_evigraph` currently reaches 60/100 numeric exact matches in oracle-doc
mode, 52/100 in open BM25 mode, 51/100 in deterministic open hybrid mode, and
61/100 in source-rerank mode. The CSVs also report diagnostic verifier metrics including arithmetic support,
