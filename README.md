...
`full_evigraph` currently reaches 62/100 numeric exact matches in oracle-doc
mode, 54/100 in open BM25 mode, 53/100 in deterministic open hybrid mode, and
63/100 in source-rerank mode. The CSVs also report diagnostic verifier metrics including arithmetic support,
