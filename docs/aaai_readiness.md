...
- Open BM25 reaches 19/100 and source-rerank reaches 31/100 for full EviGraph on the same subset; these are diagnostic baselines, not final claims.
- The experiment CSVs now separate exact match from verifier diagnostics: arithmetic support, calculation-result support, row-operation grounding, semantic grounding, and final answer support.
