...
def summarize_result(result: dict[str, Any], gold: str | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "operand_semantics_checked": bool(result.get("verification", {}).get("operand_semantics_checked", True)),
        ...
        "source_consistent": bool(result.get("verification", {}).get("source_consistent", True)),
