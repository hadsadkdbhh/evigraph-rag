...
- The current main results and failure-analysis tables are generated from
  the FinQA-300 local planner absolute-change v10 outputs and the split GPT-5.4 Direct RAG
  baseline outputs.
...
```powershell
python .\scripts\build_paper_assets.py --eval-dir .\outputs\eval\finqa_300_local_planner_absolute_change_v10 --output-dir .\paper\generated\finqa_300_local_planner_absolute_change_v10 --preset finqa_300_local
```
