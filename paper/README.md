...
- The current main results and failure-analysis tables are generated from
  the FinQA-300 local planner deferred-compensation v9 outputs and the split GPT-5.4 Direct RAG
  baseline outputs.
...
```powershell
python .\scripts\build_paper_assets.py --eval-dir .\outputs\eval\finqa_300_local_planner_deferred_comp_v9 --output-dir .\paper\generated\finqa_300_local_planner_deferred_comp_v9 --preset finqa_300_local
```
